...
- Add the resulting `.aar` file (e.g., `eclypses-aws-mte-relay-client-android-release-4.2.6-release.aar`) to the 'libs' directory.
- Add the following line to your module's `build.gradle` dependencies block:
  ```groovy
  implementation files('libs/eclypses-aws-mte-relay-client-android-release-4.2.6-release.aar')
  ```
